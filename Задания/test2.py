...
#c1 = [1, 1] c2 = [5, 5] n = 2 gamma = [0.01, 0.01] a = 1 b = 1 с2 должно быть не больше 5 при любых с1 где с1 меньше с2
#c1 = [1, 1] c2 = [5, 5] n = 2 gamma = [0.00001, 0.00001] a = 1 b = 1 чем меньше gamma тем больше вероятности что условия выполняься, разнца между элементами должна быть небольшой
#c1 = [1, 1] c2 = [5, 5] n = 2 gamma = [0.01, 0.01] a = 1 b = 1 чем больше a = b  тем болье вероятности что условия выполняься
